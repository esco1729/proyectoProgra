...
public class EjerciciosFunciones extends JFrame {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(text.contains("2x+6")) {
					Image icon = new ImageIcon(this.getClass().getResource("/img/check.jpg")).getImage();
					...
					Image icon1 = new ImageIcon(this.getClass().getResource("/img/equis.jpg")).getImage();
